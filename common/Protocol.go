...
// 应答方法
func BuildResponse(errno int, msg string, date interface{}) (resp []byte, err error) {
	// 1.定义一个response
	var (
		response Response
	)
...
//  构造任务执行计划
func BulidJobSchedulerPlan(job *Job) (jobSchedulerPlan *JobsSchedulerPlan, err error) {
	var (
	...
	//  生成调度计划
	jobSchedulerPlan = &JobsSchedulerPlan{
		Job:      job,
		Expr:     expr,
...
// 构造执行状态信息
func BuildJobExecuteInfo(jobSchedulerPlan *JobsSchedulerPlan) (jobExecuteInfo *JobExecuteInfo) {
